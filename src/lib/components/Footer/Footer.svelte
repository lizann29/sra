...
<footer class="w-full">
	<div class="relative w-full h-auto md:h-64 bg-gradient-to-r from-blue-200 via-blue-300 to-orange-200 flex items-center overflow-hidden py-8 md:py-0">
		...
		<div class="container mx-auto px-4 flex flex-col md:flex-row items-center relative z-10">
			...
			<div class="text-gray-800 mb-8 md:mb-0 text-center md:text-left">
				...
				<div class="mb-2">
					...
					<div class="flex items-center justify-center md:justify-start">
						<p class="font-bold">
							<a href="tel:+905333654128" class="hover:underline">+90 533 365 41 28</a>
						</p>
					</div>
					...
					<p class="font-bold mt-2">
						<a href="mailto:info@sra.ge" class="hover:underline">info@sra.ge</a>
					</p>
				</div>
			</div>
			...
			<div class="text-gray-800 text-center md:text-left mb-8 md:mb-0">
				...
				>
					<p class="font-bold">Krtsanisi Ortachala street</p>
					<p class="font-bold">Tbilisi</p>
				</div>
			</div>
	...
	<!-- Bottom Bar -->
	<div class="w-full bg-gray-700 py-3">
		<div class="container mx-auto px-4">
			<div class="text-white text-sm flex flex-col md:flex-row items-center justify-center md:justify-start">
				<span class="font-bold mr-2">SRA ENGINEERING</span>
				<span>International Company. © ყველა უფლება დაცულია.</span>
			</div>
		</div>
	</div>
</footer>